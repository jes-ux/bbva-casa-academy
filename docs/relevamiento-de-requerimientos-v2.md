...
- **RT-02. Soluciones de terceros para capacidades ya resueltas por la industria:** para funcionalidades donde ya existe una solución de terceros madura y ampliamente adoptada (por ejemplo, mapas interactivos, ver A.3 y A.4), usar esa solución en vez de construir una propia. No aplica a la librería de UI (RT-01), que es una decisión de negocio, no una ausencia de alternativas de mercado.
